...
#if you add many ssh keys,you can add the follow config to let password first,
#if ssh keys first,and match the above keys failed,maybe the auth times will be
#greater than auth max-time,then you cannot use password auth any more.
   Host *
